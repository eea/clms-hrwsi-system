...
def add_quicklook(product_path, sufix, keep_aux=False, reproject_to_wgs84=False):
    ...
    gdal.Translate(quicklook_path, file_path_src, format='png', outputType=gdal.GDT_Byte, width=1000, height=1000, scaleParams=[[0,420,0,210]], creationOptions=['zlevel=6'])
    if reproject_to_wgs84:
