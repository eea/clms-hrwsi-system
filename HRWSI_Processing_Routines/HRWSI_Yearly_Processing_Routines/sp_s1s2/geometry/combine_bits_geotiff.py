...
def bit_bandmath(
        output_file, raster_info_dict, source_list_per_band,
        no_data_values_per_band=None, compress=True,
    ...
    ds_out = gdal.GetDriverByName('GTiff').Create(output_file, raster_info_dict['size'][0], raster_info_dict['size'][1], nbands, raster_data_type)
