...
xml_graph_subset = """
  <node id="%(SubsetId)s">
    ...
    <sources>
      <sourceProduct refid="%(SubsetSource)s"/>
    </sources>
    <parameters class="com.bc.ceres.binding.dom.XppDomElement">
    <sourceBands/>
      <geoRegion>%(subset_region)s</geoRegion>
      <referenceBand/>
...
<node id="Terrain-Correction(%(terraincorrectionId)s)">
  ...
  <sources>
    <sourceProduct refid="%(terraincorrection_source)s"/>
  </sources>
  <parameters class="com.bc.ceres.binding.dom.XppDomElement">
      <sourceBands />
    <demName>External DEM</demName>
    <externalDEMFile>%(externalDEMFile)s</externalDEMFile>
    <externalDEMNoDataValue>%(externalDEMNoDataValue)f</externalDEMNoDataValue>
    <externalDEMApplyEGM>false</externalDEMApplyEGM>
    <demResamplingMethod>NEAREST_NEIGHBOUR</demResamplingMethod>
    ...
    <saveLocalIncidenceAngle>%(saveLocalIncidenceAngle)s</saveLocalIncidenceAngle>
